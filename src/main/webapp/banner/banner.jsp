...
<script>
    $(function () {
        $("#bntable").jqGrid({
            ...
            viewrecords: true,
            colNames: ["Id", "名称", "图片", "描述", "状态", "上传时间", /*"option"*/],
            colModel: [
                {name: "id", width: 300},
                {name: "title", editable: true},
                {
                    name: "img_path", /*width:100,*/align: "center", editable: true, edittype: "file",
...
<div class="panel panel-info">
    ...
    <button id="add" class="btn btn-success">添加轮播图</button>
    <button id="edit" class="btn btn-warning">修改轮播图</button>
    <button id="del" class="btn btn-danger">删除轮播图</button>
