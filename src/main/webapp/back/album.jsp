...
<script>
                ...
                colModel: [
                    ...
                    {name: "up_date", index: "total", width: 70, align: "right"/*, sortable: false*/},
                    {
                        ...
                        formatter: function (cellVale) {
                            /* return "<a href=''#' onclick='playerChapter(\"" + cellVale + "\")'><span class='glyphicon glyphicon-play-circle'></span></a>&emsp;&emsp;" +
    ...
    function downloadChapter(fileName) {
        alert(fileName);
        /*$.ajax({
            url: "{pageContext.request.contextPath}/chapter/downloadChapter",
            type: "post",
            dataType: "JSON",
        ...
        location.href = "${pageContext.request.contextPath}/chapter/downloadChapter?fileName=" + fileName;
