    ...
    <script>
        $(function () {
            ...
            $.extend($.validator.message, {
                required: "这是必填字段",
                minlength: $.validator.format("<sapn style='color:red'>最少要输入2个字符</span>"),
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" minlength="2" name="name" placeholder="请输入用户名..."
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/admin/getImageCode">
